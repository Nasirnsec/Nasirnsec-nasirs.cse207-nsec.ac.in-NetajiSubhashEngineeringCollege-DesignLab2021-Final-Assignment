                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6" style="margin-left: 200px;">
                                    <form role="form" method="post" action="{{route('upque',$data->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                                ...
                                                <select class="form-control" name="quecat" id="quecat" type="text" placeholder="Enter Question Paper Category">
                                                    ...
                                                    <option value="{{$data->quecategory_id}}" >{{$data->quecat->quecategory_name}}</option>
                                                    @foreach($c as $x)
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input class="form-control" value="{{$data->subject}}" name="subject" id="Input" type="text" placeholder="Enter name of Subject">
                                            </div>
                                             <div class="form-group">
                                                <label for="Select">Year</label>
                                                <input list="year" value="{{$data->year}}"placeholder="Select Year" class="form-control" name="year" >
                                                <datalist id="year">
                                                    <?php 
                                                      $right_now = getdate();
