                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6" style="margin-left: 200px;">
                                    <form role="form" method="post" action="{{route('addquecategory')}}">
                                    	@csrf
                                            <div class="form-group">
                                                <label for="Select">Question Paper Category</label>
                                                <input class="form-control" name="quecat" id="Input" type="text" placeholder="Enter Question Paper Category">
                                            </div>
