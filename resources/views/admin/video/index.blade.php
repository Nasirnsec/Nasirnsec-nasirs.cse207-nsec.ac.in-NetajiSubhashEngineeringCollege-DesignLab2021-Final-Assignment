                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                @if($x->type==' ')
                                                <iframe width="560" height="315" src="http://www.youtube.com/embed/{{$x->video}}" frameborder="0" allowfullscreen></iframe>
                                                @else
                                            ...
                                            <td><a href="{{route('editvideo',$x->id)}}" class="btn btn-info">Update</a></td>
                                            <td>
                                                <form method="post" action="{{route('delvideo',$x->id)}}">
                                                    @csrf
                                            ...
                                            <td>
                                                ...
                                                @else
                                                <form method="post" action="{{route('blockvideo',$x->id)}}">
                                                    @csrf
