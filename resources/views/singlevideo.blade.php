                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="single-page-post">
                            @if($data->type==' ')
                                                <iframe  src="http://www.youtube.com/embed/{{$data->video}}" style="height: 500px;width: 700px;" frameborder="0" allowfullscreen></iframe>
                                                @else
                                            <video id="vid1"  controls> 
                                                 <source style="height: 500px;width: 700px;" src="{{URL::to('/')}}/upload/{{$data->video}}" id="vid-src" type="video/{{$x->type}}">
                            ...
                            <section class="commentform-area  pb-120 pt-80 mb-100">
                                <div class="container">
                                    ...
                                    <div class="row flex-row d-flex">
                                        ...
                                        <form method="post" action="{{route('comment',[$data->id,'Video'])}}">
                                            @csrf
